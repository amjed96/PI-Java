        ...
        Ajout.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    Ajout.getScene().setRoot(FXMLLoader.load(getClass().getResource("../edu/connection3A17/views/ajoutCategorie.fxml")));
        ...
        Display.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    Ajout.getScene().setRoot(FXMLLoader.load(getClass().getResource("../edu/connection3A17/views/approuveOpportunite.fxml")));
                } catch (IOException ex) {
                    Logger.getLogger(mainController.class.getName()).log(Level.SEVERE, null, ex);
                }
